...
export default function NaturoDossier({ naturoKey, data }) {
  const { months, params, naturoProfiles = [], saveReerVisibility, linkNaturoAccount, publishNaturoSnapshots } = data
  ...
  return (
    <div className="space-y-5">
      ...
      {saveReerVisibility && (
        <Card className="p-4">
          <h4 className="text-sm font-bold text-[#1a1a1a] mb-3">Accès du naturo à son espace REER</h4>
